...
jest.mock('@/lib/validation-schemas', function() { return { LOGIN_RULES: {} } })
...
describe('Login Page', function() {
  it('renders Operator Authentication text', function() {
    var { getByText } = render(React.createElement(LoginPage))
    expect(getByText('operator_authentication')).toBeTruthy()
  })
})
